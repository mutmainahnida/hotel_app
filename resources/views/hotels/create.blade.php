...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Create New Hotel') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hotels.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="penilaian" class="col-md-4 col-form-label text-md-right">{{ __('Penilaian') }}</label>

                            <div class="col-md-6">
                                <input id="penilaian" type="number" class="form-control @error('penilaian') is-invalid @enderror" name="penilaian" value="{{ old('penilaian') }}" min="0" max="5">
